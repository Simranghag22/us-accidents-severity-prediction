# US Traffic Road Accident Hotspot & Risk Factor Analysis

A data science capstone project that analyzes 7.7 million US traffic accident records (2016–2023) to identify the temporal, environmental, and infrastructural factors behind accident frequency and severity — then extends that exploratory analysis into a machine learning model that predicts severe-accident risk in real time, plus an unsupervised layer that groups accident hotspots into risk tiers.
...
| Resource | Link |
|---|---|
| 📓 Notebook | [`02_Notebook/US_Traffic_Accident_Hotspot_Risk_Factor_Analysis_ML_Extension.ipynb`](./US_Traffic_Accident_Hotspot_Risk_Factor_Analysis/02_Notebook/US_Traffic_Accident_Hotspot_Risk_Factor_Analysis_ML_Extension.ipynb) |
| 📄 Full Project Report | [`03_Project_Report/Report-US_Traffic_Accident_Hotspot_Risk_Factor_Analysis_Report.pdf`](./US_Traffic_Accident_Hotspot_Risk_Factor_Analysis/03_Project_Report/Report-US_Traffic_Accident_Hotspot_Risk_Factor_Analysis_Report.pdf) |
...
![Training Certificate](./US_Traffic_Accident_Hotspot_Risk_Factor_Analysis/04_Certificates/Training_Certificate.png)
...
![Internship Certificate](./US_Traffic_Accident_Hotspot_Risk_Factor_Analysis/04_Certificates/Internship_Certificate.png)
